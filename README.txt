...
SparseDataFrame - dziedziczaca klasa po DataFrame dla rzadkich danych
DataFrameDB - dziedziczaca klasa po DataFrame do obsługi ramek danych przez baze danych
DataFrameMultiThreads - wielowatkowa klasa do obsługi ramek danych(wielowštkowe operacje max,min.. i groupby)
